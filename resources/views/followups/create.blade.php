@extends('layouts.app')
@section('title', 'Add Follow-up — CRM Admin')
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-black text-slate-800 dark:text-white leading-tight">Schedule Follow-up</h1>
            <p class="text-sm text-slate-400 mt-1 font-medium">Create a new activity or reminder</p>
        </div>
    </div>

    <form action="{{ route('followups.store') }}" method="POST" class="space-y-6">
        @csrf
